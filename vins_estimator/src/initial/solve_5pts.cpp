...
// #include <sophus/se3.h>     // △△△△△ zlc新增的头文件 △△△△△
// #include <sophus/so3.h>     // △△△△△ zlc新增的头文件 △△△△△
#include "../sophus/se3.h"
#include "../sophus/so3.h"

using Sophus::SE3;          // △△△△△ zlc新增的语句 △△△△△
using Sophus::SO3;          // △△△△△ zlc新增的语句 △△△△△
...
bool MotionEstimator::solveRelativeRT(const vector<pair<Vector3d, Vector3d>>& corres, Matrix3d& Rotation, Vector3d& Translation)
{
    if (corres.size() >= 15)
    {
        ...
        if(inlier_cnt > 12)
        {
            ROS_ERROR_STREAM("----------5points-----------");       // △△△△△ zlc新增的语句 △△△△△
            ROS_ERROR_STREAM(ll.size());                            // △△△△△ zlc新增的语句 △△△△△
            ROS_ERROR_STREAM(inlier_cnt);                           // △△△△△ zlc新增的语句 △△△△△
            ROS_ERROR_STREAM(Rotation);                             // △△△△△ zlc新增的语句 △△△△△
            ROS_ERROR_STREAM(Translation);                          // △△△△△ zlc新增的语句 △△△△△
            return true;
        }
        else
            return false;
